...
public class Config {
    public static class CommonConfig {
        ...
        public final ForgeConfigSpec.BooleanValue IgnoreWorldData;
        ...
        public CommonConfig(ForgeConfigSpec.@NotNull Builder builder) {
            ...
            IgnoreWorldData = builder.comment("If set to true Herobrine mobs can exist before an Altar of Herobrine is activated in a world.").worldRestart().define("IgnoreWorldData", false);
            ...
            CursedForestBiomeWeight = builder.comment("The spawn weight of the Cursed Forest biome. Greater values make the biome more common. Setting the value to 0 disables the biome, while 1024 makes the entire world a Cursed Forest.").worldRestart().defineInRange("CursedForestBiomeWeight", 2, 0, 1024);
            builder.pop();
