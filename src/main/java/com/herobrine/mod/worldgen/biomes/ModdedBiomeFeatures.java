...
public class ModdedBiomeFeatures {
    ...
    public static final ConfiguredFeature<?, ?> CURSED_TREES = register("cursed_trees", Feature.RANDOM_SELECTOR.configured(new MultipleRandomFeatureConfig(ImmutableList.of(CURSED_BIRCH_TREE.weighted(0.2F)), CURSED_OAK_TREE)).decorated(Features.Placements.HEIGHTMAP).decorated(Placement.COUNT_EXTRA.configured(new AtSurfaceWithExtraConfig(10, 0.1F, 1))));
