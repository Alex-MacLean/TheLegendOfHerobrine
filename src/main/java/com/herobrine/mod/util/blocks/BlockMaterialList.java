...
public class BlockMaterialList {
    ...
    public static final Material PURIFIED_DIAMOND_BLOCK_MATERIAL = new Material(MaterialColor.LIGHT_BLUE, false, true, true, true, false, false, false, PushReaction.NORMAL);
}
