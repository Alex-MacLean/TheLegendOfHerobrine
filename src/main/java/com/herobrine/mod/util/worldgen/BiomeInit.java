...
public class BiomeInit {
    ...
    public static void registerBiomes() {
        registerBiome(CURSED_FOREST.get(), BiomeManager.BiomeType.WARM, Config.COMMON.CursedForestBiomeWeight.get(), Type.FOREST, Type.OVERWORLD, Type.DEAD, Type.WASTELAND, Type.MAGICAL, Type.RARE);
    }
