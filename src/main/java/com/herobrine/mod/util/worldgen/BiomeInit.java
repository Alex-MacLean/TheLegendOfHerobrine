...
public class BiomeInit {
    ...
    public static void registerBiomes() {
        registerBiome(CURSED_FOREST.get(), BiomeManager.BiomeType.WARM, Config.COMMON.CursedForestWeight.get(), Type.FOREST, Type.OVERWORLD, Type.DEAD, Type.SPOOKY, Type.WASTELAND, Type.MAGICAL, Type.RARE);
    }
