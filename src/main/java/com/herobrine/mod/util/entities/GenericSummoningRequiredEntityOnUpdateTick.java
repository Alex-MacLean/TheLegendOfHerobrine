...
public class GenericSummoningRequiredEntityOnUpdateTick extends ElementsHerobrine.ModElement {
    public GenericSummoningRequiredEntityOnUpdateTick(ElementsHerobrine instance) {
        super(instance, 9);
    }
