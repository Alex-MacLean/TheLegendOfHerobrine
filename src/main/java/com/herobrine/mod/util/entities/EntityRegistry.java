...
public class EntityRegistry {
    ...
    public static void registerEntitySpawnEggs(@NotNull final RegistryEvent.Register<Item> event) {
        event.getRegistry().registerAll(
                ...
                ItemList.herobrine_spy_spawn_egg = registerEntitySpawnEgg(HEROBRINE_SPY_ENTITY, 0x000000, 0x00ff44, "herobrine_spy_spawn_egg")
        );
    }
    ...
    public static void registerEntityWorldSpawns() {
        ...
        registerEntityWorldSpawn(HEROBRINE_WARRIOR_ENTITY, 1,1, 1, Biomes.MUSHROOM_FIELD_SHORE, Biomes.MUSHROOM_FIELDS);
