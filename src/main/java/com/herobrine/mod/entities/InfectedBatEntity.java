...
public class InfectedBatEntity extends AbstractInfectedEntity implements IFlyingAnimal {
    ...
    public boolean attackEntityFrom(@NotNull DamageSource source, float amount) {
        if (source.getImmediateSource() instanceof HolyWaterEntity) {
            ...
            batEntity.setLocationAndAngles(this.posX, this.posY, this.posZ, this.rotationYaw, this.rotationPitch);
    ...
    public void tick() {
        ...
        if (this.getIsBatHanging()) {
            ...
            this.setPosition(this.posX, (double) MathHelper.floor(this.posY) + 1.0D - (double)this.getHeight(), this.posZ);
        } else {
