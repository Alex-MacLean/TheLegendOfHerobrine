...
public class Config {
    public static class CommonConfig {
        ...
        public CommonConfig(ForgeConfigSpec.@NotNull Builder builder) {
            ...
            ShrineRemnantSpawnWeight = builder.comment("The spawn weight of the Shrine Remnant Structure. Greater values make the structure more common. Setting the value to 0 disables the structure, while 1000000 covers the entire world in Shrine Remnants.").worldRestart().defineInRange("ShrineRemnantSpawnWeight", 200000, 0, 1000000);
