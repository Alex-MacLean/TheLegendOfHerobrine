...
public class HerobrineStatueTop extends Block {
    @GameRegistry.ObjectHolder(HerobrineMod.MODID + ":herobrine_statue_top")
    ...
    public HerobrineStatueTop() {
        ...
        this.setRegistryName(HerobrineMod.location("herobrine_statue_top"));
        this.setTranslationKey(HerobrineMod.MODID + "." + "herobrine_statue_top");
    ...
    {
        return HerobrineStatue.block.getItemDropped(HerobrineStatue.block.getDefaultState(), rand, fortune);
    }
