...
public class InfectedBatEntityModel extends SegmentedModel<InfectedBatEntity> {
    ...
    @Override
    public @NotNull Iterable<ModelRenderer> getParts() {
        return ImmutableList.of(this.batHead, this.batBody);
    }

    public void setRotationAngles(@NotNull InfectedBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
