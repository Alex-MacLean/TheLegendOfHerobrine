...
public class InfectedRabbitEntityModel extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, @NotNull Entity entityIn) {
        ...
        InfectedRabbitEntity infectedRabbitEntity = (InfectedRabbitEntity)entityIn;
        ...
        this.jumpRotation = MathHelper.sin(infectedRabbitEntity.getJumpCompletion(f) * (float)Math.PI);
    ...
    public void setLivingAnimations(@NotNull EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        this.jumpRotation = MathHelper.sin(((InfectedRabbitEntity)entitylivingbaseIn).getJumpCompletion(partialTickTime) * (float)Math.PI);
    }
}
