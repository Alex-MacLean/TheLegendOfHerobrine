...
public class InfectedDonkeyEntityModel extends ModelBase {
    ...
    public InfectedDonkeyEntityModel() {
    ...
    public void render(@NotNull Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        InfectedDonkeyEntity donkeyEntity = (InfectedDonkeyEntity)entityIn;
        boolean flag = donkeyEntity.isChild();
        boolean flag1 = !flag && donkeyEntity.isHorseSaddled();
        float f1 = 0.5F;
        boolean flag4 = donkeyEntity.isBeingRidden();
        ...
        if (flag) {
            ...
            GlStateManager.translate(0.0F, 0.9F * (1.0F - f1)  + 1.35F * (1.0F - f1) * (1.0F), 0.15F * (1.0F - f1));
        }
    ...
    public void setLivingAnimations(@NotNull EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        InfectedDonkeyEntity donkeyEntity = (InfectedDonkeyEntity)entitylivingbaseIn;
        float f5 = donkeyEntity.getGrassEatingAmount(partialTickTime);
        float f6 = donkeyEntity.getRearingAmount(partialTickTime);
        float f7 = 1.0F - f6;
        float f8 = donkeyEntity.getMouthOpennessAngle(partialTickTime);
        boolean flag = donkeyEntity.tailCounter != 0;
        boolean flag1 = donkeyEntity.isHorseSaddled();
        boolean flag2 = donkeyEntity.isBeingRidden();
