...
public class InfectedDonkeyEntityModel extends AgeableModel<InfectedDonkeyEntity> {
    ...
    @Override
    public void setupAnim(@NotNull InfectedDonkeyEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public void prepareMobModel(@NotNull InfectedDonkeyEntity entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
