...
public class InfectedDonkeyEntityModel extends AgeableModel<InfectedDonkeyEntity> {
    ...
    @Override
    public void setRotationAngles(@NotNull InfectedDonkeyEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
