...
public class HerobrineWarriorEntityRenderer extends RenderLiving<HerobrineWarriorEntity> {
    public static ResourceLocation TEXTURES = HerobrineMod.location("textures/entity/herobrine.png");

    public HerobrineWarriorEntityRenderer(RenderManager manager) {
    ...
    @Override
    protected ResourceLocation getEntityTexture(@NotNull HerobrineWarriorEntity entity) {
        return TEXTURES;
    }
