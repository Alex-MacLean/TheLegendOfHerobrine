...
public class InfectedHorseEntityModel extends AnimalModel<InfectedHorseEntity> {
    ...
    public InfectedHorseEntityModel(@NotNull ModelPart root){
    ...
    public static @NotNull TexturedModelData getTexturedModelData() {
        ...
        ModelPartData modelPartData4 = modelPartData3.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create().uv(0, 13).cuboid(-3.0f, -11.0f, -2.0f, 6.0f, 5.0f, 7.0f, Dilation.NONE), ModelTransform.NONE);
        modelPartData3.addChild(EntityModelPartNames.MANE, ModelPartBuilder.create().uv(56, 36).cuboid(-1.0f, -11.0f, 5.01f, 2.0f, 16.0f, 2.0f, Dilation.NONE), ModelTransform.NONE);
        modelPartData3.addChild("upper_mouth", ModelPartBuilder.create().uv(0, 25).cuboid(-2.0f, -11.0f, -7.0f, 4.0f, 5.0f, 5.0f, Dilation.NONE), ModelTransform.NONE);
        modelPartData.addChild(EntityModelPartNames.LEFT_HIND_LEG, ModelPartBuilder.create().uv(48, 21).mirrored().cuboid(-3.0f, -1.01f, -1.0f, 4.0f, 11.0f, 4.0f, Dilation.NONE), ModelTransform.pivot(4.0f, 14.0f, 7.0f));
        modelPartData.addChild(EntityModelPartNames.RIGHT_HIND_LEG, ModelPartBuilder.create().uv(48, 21).cuboid(-1.0f, -1.01f, -1.0f, 4.0f, 11.0f, 4.0f, Dilation.NONE), ModelTransform.pivot(-4.0f, 14.0f, 7.0f));
        modelPartData.addChild(EntityModelPartNames.LEFT_FRONT_LEG, ModelPartBuilder.create().uv(48, 21).mirrored().cuboid(-3.0f, -1.01f, -1.9f, 4.0f, 11.0f, 4.0f, Dilation.NONE), ModelTransform.pivot(4.0f, 14.0f, -12.0f));
        modelPartData.addChild(EntityModelPartNames.RIGHT_FRONT_LEG, ModelPartBuilder.create().uv(48, 21).cuboid(-1.0f, -1.01f, -1.9f, 4.0f, 11.0f, 4.0f, Dilation.NONE), ModelTransform.pivot(-4.0f, 14.0f, -12.0f));
        modelPartData2.addChild(EntityModelPartNames.TAIL, ModelPartBuilder.create().uv(42, 36).cuboid(-1.5f, 0.0f, 0.0f, 3.0f, 14.0f, 4.0f, Dilation.NONE), ModelTransform.of(0.0f, -5.0f, 2.0f, 0.5235988f, 0.0f, 0.0f));
    ...
    @Override
    public void setAngles(InfectedHorseEntity entity, float f, float g, float h, float i, float j) {
    ...
    @Override
    public void animateModel(InfectedHorseEntity entity, float f, float g, float h) {
