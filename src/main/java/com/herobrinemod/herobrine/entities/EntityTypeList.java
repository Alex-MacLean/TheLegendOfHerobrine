...
public class EntityTypeList {
    ...
    public static final EntityType<InfectedCamelEntity> INFECTED_CAMEL = Registry.register(ENTITY_TYPE, new Identifier(HerobrineMod.MODID, "infected_camel"), FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, InfectedCamelEntity::new).dimensions(EntityDimensions.fixed(1.7f, 2.375f)).build());
}
