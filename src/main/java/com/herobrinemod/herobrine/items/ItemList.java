...
public class ItemList {
    // Initialize items
    public static final Item BEDROCK_SWORD = new SwordItem(ToolMaterialList.BEDROCK, 0, -2.4f, new Item.Settings().rarity(Rarity.EPIC));
    ...
    public static final Item CURSED_DIAMOND_SWORD = new CursedDiamondSwordItem(ToolMaterialList.CURSED_DIAMOND, 3, -2.4f, new Item.Settings());
    public static final Item CURSED_DIAMOND_AXE = new CursedDiamondAxeItem(ToolMaterialList.CURSED_DIAMOND, 5, -3.0f, new Item.Settings());
    public static final Item CURSED_DIAMOND_PICKAXE = new PickaxeItem(ToolMaterialList.CURSED_DIAMOND, 1, -2.8f, new Item.Settings());
    public static final Item CURSED_DIAMOND_SHOVEL = new ShovelItem(ToolMaterialList.CURSED_DIAMOND, 1.5f, -3.0f, new Item.Settings());
    public static final Item CURSED_DIAMOND_HOE = new CursedDiamondHoeItem(ToolMaterialList.CURSED_DIAMOND, -4, 0.0f, new Item.Settings());
