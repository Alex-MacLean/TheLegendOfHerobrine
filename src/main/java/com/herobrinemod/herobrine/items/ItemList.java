...
public class ItemList {
    ...
    public static final Item CURSED_DIAMOND_HELMET = new ArmorItem(ArmorMaterialList.CURSED_DIAMOND_ARMOR_MATERIAL, EquipmentSlot.HEAD, new Item.Settings());
    public static final Item CURSED_DIAMOND_CHESTPLATE = new ArmorItem(ArmorMaterialList.CURSED_DIAMOND_ARMOR_MATERIAL, EquipmentSlot.CHEST, new Item.Settings());
    public static final Item CURSED_DIAMOND_LEGGINGS = new ArmorItem(ArmorMaterialList.CURSED_DIAMOND_ARMOR_MATERIAL, EquipmentSlot.LEGS, new Item.Settings());
    public static final Item CURSED_DIAMOND_BOOTS = new ArmorItem(ArmorMaterialList.CURSED_DIAMOND_ARMOR_MATERIAL, EquipmentSlot.FEET, new Item.Settings());
