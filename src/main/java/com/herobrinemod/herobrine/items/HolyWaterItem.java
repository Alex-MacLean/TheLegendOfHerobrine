...
import com.herobrinemod.herobrine.entities.HolyWaterEntity;
...
public class HolyWaterItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(@NotNull World world, @NotNull PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            HolyWaterEntity entity = new HolyWaterEntity((EntityType<? extends ThrownItemEntity>) EntityTypeList.HOLY_WATER, user, world);
